...
// Enable specific skinning functions for shadow vertex as they will have less inputs/data. Only if vertex split streams are supported.
...
#if defined(DX12) || defined(VULKAN)
    uv.y = 1.0 - uv.y;
#endif
	return uv;
}
