...
#define GAMEPAD_AXLEFT_X        0
#define GAMEPAD_AXLEFT_Y        1
#define GAMEPAD_AXRIGHT_X       2
#define GAMEPAD_AXRIGHT_Y       3
#define GAMEPAD_AXLEFT_TRIGGER  4
#define GAMEPAD_AXRIGHT_TRIGGER 5
#define GAMEPAD_AXLAST          GAMEPAD_AXRIGHT_TRIGGER
