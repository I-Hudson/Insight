project "assimp"  
    ...
    {
        "%{folderDir}" .. "include",
        "%{folderDir}" .. "contrib/irrXML",
        "%{folderDir}" .. "contrib/stb",
        "%{folderDir}" .. "contrib/unzip",
        "%{folderDir}" .. "contrib/utf8cpp",
        "%{folderDir}" .. "contrib/zip",
        "%{folderDir}" .. "contrib/zlib",
        "%{folderDir}" .. "contrib/rapidjson/include",
    }
