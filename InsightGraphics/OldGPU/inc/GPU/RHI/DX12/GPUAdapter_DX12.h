...
namespace Insight
{
	namespace Graphics
	{
		namespace RHI::DX12
		{
			...
			class GPUAdapter_DX12 : public GPUAdapter
			{
			public:
				GPUAdapter_DX12();
				GPUAdapter_DX12(const GPUAdapter_DX12& other);
				GPUAdapter_DX12(IDXGIAdapter1* device);

				GPUAdapter_DX12& operator=(const GPUAdapter_DX12& other);
				GPUAdapter_DX12& operator=(GPUAdapter_DX12&& other);
