...
public:
    ...
    static u32 SizeInBytes(const PixelFormat format)
    {
    ...
    static u32 SizeInBits(PixelFormat format);
    ...
    /// <param name="format">The pixel format</param>
    /// <returns>The size in bits</returns>
    static u32 AlphaSizeInBits(PixelFormat format);
    ...
    static bool HasAlpha(const PixelFormat format)
    {
    ...
    static u32 ComputeScanlineCount(PixelFormat format, int height);
    ...
    static u32 ComputeComponentsCount(PixelFormat format);
