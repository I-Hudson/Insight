...
namespace Maths
{
    ...
    IS_API void SinCos(float angle, float& sine, float& cosine);
    ...
    IS_API U32 FloorLog2(U32 value);
    ...
    static FORCE_INLINE I32 Abs(const I32 value)
    {
        return value < 0 ? -value : value;
    }

    static FORCE_INLINE I64 Abs(const I64 value)
    {
        return value < 0 ? -value : value;
    }
    ...
    static I32 TruncToInt(float value)
    {
        return (I32)value;
    }

    static I32 FloorToInt(float value)
    {
        return TruncToInt(floorf(value));
    }

    static FORCE_INLINE I32 RoundToInt(float value)
    {
        return FloorToInt(value + 0.5f);
    }

    static FORCE_INLINE I32 CeilToInt(float value)
    {
    ...
    static I32 RoundUpToPowerOf2(I32 value)
    {
        // Source:
    ...
    /// <param name="value">The value.</param>
    /// <returns>The power of 2.</returns>
    static U32 RoundUpToPowerOf2(U32 value)
    {
        // Source:
        // http://graphics.stanford.edu/~seander/bithacks.html#RoundUpPowerOf2
        value++;
    ...
    /// <param name="value">The value.</param>
    /// <returns>The power of 2.</returns>
    static I64 RoundUpToPowerOf2(I64 value)
    {
        // Source:
        // http://graphics.stanford.edu/~seander/bithacks.html#RoundUpPowerOf2
        if (value < 0)
    ...
    static bool NotNearEqual(float a, float b)
    {
        ...
        const I32 aInt = *(I32*)&a;
        const I32 bInt = *(I32*)&b;
