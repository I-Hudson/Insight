...
public:
	...
	/// GPU Resources types.
	/// </summary>
	DECLARE_ENUM_13(ResourceType, RenderTarget, Image, ImageView, Texture, CubeTexture, VolumeTexture, Buffer, Shader, PipelineState, Descriptor, Query, CommandBuffer, CommandPool);
