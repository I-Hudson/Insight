...
public:
	...
	/// GPU Resources types.
	/// </summary>
	DECLARE_ENUM_12(ResourceType, RenderTarget, Image, ImageView, Texture, CubeTexture, VolumeTexture, Buffer, Shader, PipelineState, Descriptor, Query, CommandBuffer);
