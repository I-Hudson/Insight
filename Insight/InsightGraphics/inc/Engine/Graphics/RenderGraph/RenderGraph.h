...
namespace Insight::Graphics
{
	...
	using RG_GPUResultFunc = std::function<void(GPUResults)>;
	...
	public:
		...
		void SetGPUResultFunc(RG_GPUResultFunc func) { m_gpuResultFunc = func; }

		/// <summary>
		/// Rebuild the swapchain as it is not longer optimal.
		/// </summary>
		void SwapchainRebuild(u32 width, u32 height);
	...
	protected:
		...
		RG_GPUResultFunc m_gpuResultFunc;
