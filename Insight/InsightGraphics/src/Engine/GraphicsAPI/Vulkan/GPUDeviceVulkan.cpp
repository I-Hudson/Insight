...
namespace Insight::GraphicsAPI::Vulkan
{
	...
	Graphics::GPUContext* GPUDeviceVulkan::GetMainContext()
	{
		return nullptr;
	}
	...
	bool GPUDeviceVulkan::Init(Graphics::GPUDeviceDesc const& desc)
	{
		m_desc = desc;
...
#undef CHECK_BUFFER_FORMAT
	...
	{
		Graphics::GPUDeviceLock lock(this);
