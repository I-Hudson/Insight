...
namespace Insight
{
	namespace Render
	{
		...
		public:
			...
			static VkDescriptorPoolCreateInfo DescPoolCreateInfo(const int& count, const std::vector<VkDescriptorPoolSize>& poolPtr, const int& maxSets)
			{
				VkDescriptorPoolCreateInfo poolInfo = {};
				poolInfo.sType = VK_STRUCTURE_TYPE_DESCRIPTOR_POOL_CREATE_INFO;
				poolInfo.poolSizeCount = count;
				poolInfo.pPoolSizes = poolPtr.data();
			...
			static VkWriteDescriptorSet WriteDescriptorSet(const VkDescriptorSet& descriptorSets, const int& binding, const int& arrayElement,
				const VkDescriptorType type, const int& descriptorCount, const VkDescriptorBufferInfo* bufferInfo, const VkDescriptorImageInfo* imageInfo)
			{
