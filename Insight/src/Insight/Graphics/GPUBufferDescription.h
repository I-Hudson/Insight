...
#include "Core/Core.h"
#include "Enums/GPUResourceUsage.h"
...
struct IS_API GPUBufferDescription
{
    /// <summary>
...
/// <returns>The buffer description.</returns>
    static GPUBufferDescription Buffer(U32 size, GPUBufferFlags flags, PixelFormat format = PixelFormat::Unknown, const void* initData = nullptr, U32 stride = 0, GPUResourceUsage usage = GPUResourceUsage::Default);
    ...
    /// </remarks>
    static GPUBufferDescription Typed(I32 count, PixelFormat viewFormat, bool isUnorderedAccess = false, GPUResourceUsage usage = GPUResourceUsage::Default);
    ...
    /// Example in HLSL: Buffer&lt;float4&gt;.
    /// </remarks>
    static GPUBufferDescription Typed(const void* data, I32 count, PixelFormat viewFormat, bool isUnorderedAccess = false, GPUResourceUsage usage = GPUResourceUsage::Default);
    ...
    /// <param name="data">The data.</param>
    /// <returns>The buffer description.</returns>
    static GPUBufferDescription Vertex(I32 elementStride, I32 elementsCount, void* data)
    {
    ...
    /// <returns>The buffer description.</returns>
    static GPUBufferDescription Vertex(I32 elementStride, I32 elementsCount, GPUResourceUsage usage = GPUResourceUsage::Default)
    {
    ...
    /// <param name="usage">The usage mode.</param>
    /// <returns>The buffer description.</returns>
    static GPUBufferDescription Vertex(I32 size, GPUResourceUsage usage = GPUResourceUsage::Default)
    {
    ...
    /// <param name="data">The data.</param>
    /// <returns>The buffer description.</returns>
    static GPUBufferDescription Index(I32 elementStride, I32 elementsCount, void* data)
    {
    ...
    /// <param name="usage">The usage mode.</param>
    /// <returns>The buffer description.</returns>
    static GPUBufferDescription Index(I32 elementStride, I32 elementsCount, GPUResourceUsage usage = GPUResourceUsage::Default)
    {
        const auto format = elementStride == 4 ? PixelFormat::R32_UInt : PixelFormat::R16_UInt;
    ...
    /// </remarks>
    static GPUBufferDescription Structured(I32 elementCount, I32 elementSize, bool isUnorderedAccess = false)
    {
    ...
    /// </remarks>
    static GPUBufferDescription StructuredAppend(I32 elementCount, I32 elementSize)
    {
    ...
    /// Example in HLSL: StructuredBuffer&lt;float4&gt; or RWStructuredBuffer&lt;float4&gt; for structured buffers supporting unordered access.
    /// </remarks>
    static GPUBufferDescription StructuredCounter(I32 elementCount, I32 elementSize)
    {
    ...
    /// <param name="usage">The usage.</param>
    /// <returns>The buffer description.</returns>
    static GPUBufferDescription Argument(I32 size, GPUResourceUsage usage = GPUResourceUsage::Default)
    {
    ...
    /// <param name="usage">The usage.</param>
    /// <returns>The buffer description.</returns>
    static GPUBufferDescription Argument(const void* data, I32 size, GPUResourceUsage usage = GPUResourceUsage::Default)
    {
    ...
    /// <param name="usage">The usage.</param>
    /// <returns>The buffer description.</returns>
    static GPUBufferDescription Raw(I32 size, GPUBufferFlags additionalFlags = GPUBufferFlags::None, GPUResourceUsage usage = GPUResourceUsage::Default)
    {
    ...
    /// <param name="usage">The usage.</param>
    /// <returns>The buffer description.</returns>
    static GPUBufferDescription Raw(const void* data, I32 size, GPUBufferFlags additionalFlags = GPUBufferFlags::None, GPUResourceUsage usage = GPUResourceUsage::Default)
    {
