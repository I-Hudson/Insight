...
/// </summary>
DECLARE_ENUM_EX_7(DayOfWeek, I32, 0, Monday, Tuesday, Wednesday, Thursday, Friday, Saturday, Sunday);

/// <summary>
/// The months of the year.
/// </summary>
DECLARE_ENUM_EX_12(MonthOfYear, I32, 1, January, February, March, April, May, June, July, August, September, October, November, December);

/// <summary>
/// Represents date and time.
/// </summary>
struct IS_API DateTime
{
private:

    static const I32 CachedDaysPerMonth[];
    static const I32 CachedDaysToMonth[];
...
public:
    ...
    I32 GetHour() const
    {
        return static_cast<I32>(Ticks / Constants::TicksPerHour % 24);
    }
    ...
    {
        return static_cast<I32>(Ticks / Constants::TicksPerMillisecond % 1000);
    }
    ...
    I32 GetMinute() const
    {
        return static_cast<I32>(Ticks / Constants::TicksPerMinute % 60);
    }
    ...
    I32 GetSecond() const
    {
        return static_cast<I32>(Ticks / Constants::TicksPerSecond % 60);
    }
    ...
    I32 ToUnixTimestamp() const
    {
        return static_cast<I32>((Ticks - DateTime(1970, 1, 1).Ticks) / Constants::TicksPerSecond);
    }
...
public:
    ...
    {
        return DateTime(static_cast<I64>((julianDay - 1721425.5) * Constants::TicksPerDay));
    }
    ...
    static DateTime FromUnixTimestamp(I32 unixTime)
    {
        return DateTime(1970, 1, 1) + TimeSpan(static_cast<I64>(unixTime) * Constants::TicksPerSecond);
    }
...
namespace fmt
{
    ...
    struct formatter<DateTime, char>
    {
        ...
        auto format(const DateTime& v, FormatContext& ctx)
        {
            ...
            return format_to(ctx.out(), "{0}-{1:0>2}-{2:0>2} {3:0>2}:{4:0>2}:{5:0>2}", year, month, day, v.GetHour(), v.GetMinute(), v.GetSecond());
        }
    };
}
