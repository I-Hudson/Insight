...
public:
    ...
    /// <param name="a">The alpha channel.</param>
    /// <returns>The color.</returns>
    static Color FromRGB(U32 rgb, float a = 1.0f)
    {
    ...
    static Color FromHex(const std::string& hexString, bool& isValid);
    ...
    /// <param name="hsv">The HSV color.</param>
        /// <param name="alpha">The alpha value. Default is 1.</param>
    /// <returns>The RGB color.</returns>
    static Color FromHSV(const glm::vec3& hsv, float alpha = 1.0f);
...
public:
    ...
    {
        R = Maths::Saturate(R * b);
        G = Maths::Saturate(G * b);
        B = Maths::Saturate(B * b);
        return *this;
    }
...
public:
    ...
    {
        return Maths::NearEqual(a.R, b.R) && Maths::NearEqual(a.G, b.G) & Maths::NearEqual(a.B, b.B) && Maths::NearEqual(a.A, b.A);
    }

    static bool NearEqual(const Color& a, const Color& b, float epsilon)
    {
        return Maths::NearEqual(a.R, b.R, epsilon) && Maths::NearEqual(a.G, b.G, epsilon) & Maths::NearEqual(a.B, b.B, epsilon) && Maths::NearEqual(a.A, b.A, epsilon);
    }
...
public:
    ...
    {
        result.R = Maths::Lerp(start.R, end.R, amount);
        result.G = Maths::Lerp(start.G, end.G, amount);
        result.B = Maths::Lerp(start.B, end.B, amount);
        result.A = Maths::Lerp(start.A, end.A, amount);
    }
...
public:
    ...
    static U32 GetHashCode(const Color& v)
    {
...
inline U32 GetHash(const Color& key)
{
