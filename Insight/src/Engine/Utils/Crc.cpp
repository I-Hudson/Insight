...
U32 Crc::CachedCRCTablesSB8[8][256] =
{
    {
        0x00000000,
        0x77073096,
...
{
#if BUILD_DEBUG
    U32 rCrc32Poly = ReverseBits((U32)Crc32Poly);
    ...
    for (U32 i = 0; i != 256; ++i)
    {
        U32 CRC = CachedCRCTablesSB8[0][i];
        for (U32 j = 1; j != 8; ++j)
        {
...
U32 Crc::MemCrc32(const void* data, I32 length, U32 crc)
{
    // Based on the Slicing-by-8 implementation found here:
    // http://slicing-by-8.sourceforge.net/
    ...
    const U8* __restrict ptr = (U8*)data;

    // First we need to align to 32-bits
    I32 initBytes = (I32)(AlignUp<U64>((U64)ptr, 4) - (U64)ptr);
