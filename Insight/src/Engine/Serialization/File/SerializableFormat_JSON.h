...
#include "json.hpp"
	...
	namespace Serialization
	{
		...
		private: 
			void SerializeElement(nlohmann::json& doc, nlohmann::json* node, SerializableElement* element);
			void DeserializeElement(nlohmann::json& doc, const nlohmann::json* node, SerializableElement* element);
