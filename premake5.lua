...
IncludeDir["stb_image"] = "$(SolutionDir)Insight/vendor/stb"
IncludeDir["imgui"] = "$(SolutionDir)Insight/vendor/imgui/"
IncludeDir["imguizmo"] = "$(SolutionDir)Insight/vendor/ImGuizmo/"
...
group "Dependencies"
    include "Insight/vendor/GLFW/premake5.lua"
    include "Insight/vendor/Glad/premake5.lua"
    include "Insight/vendor/ImGui/premake5.lua"
    include "Insight/vendor/ImGuizmo/premake5.lua"
    include "Insight/vendor/SPIRV-Cross/premake5.lua"
    include "Insight/vendor/Reflect/ReflectEXE/premake5.lua"
    include "Insight/vendor/JobSystem/JobSystem/premake5.lua"
group ""
