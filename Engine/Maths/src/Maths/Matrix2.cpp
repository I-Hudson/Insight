...
namespace test
{
	...
	TEST_SUITE("Matrix2")
	{
		...
		TEST_CASE("Divition")
		{
			...
			Matrix2 result = one / two;
			CHECK(Equals(result.m_00, 0.71429f, 0.0001f));
			CHECK(Equals(result.m_01, 0.85714f, 0.0001f));
			CHECK(Equals(result.m_10, 1.42857f, 0.0001f));
			CHECK(Equals(result.m_11, -0.28571f, 0.0001f));

			Vector2 vec = Vector2(5, 7);
			result = one /= vec;
			CHECK(Equals(result.m_00, 0.8f, 0.0001f));
			CHECK(Equals(result.m_01, 1.4f, 0.0001f));
			CHECK(Equals(result.m_10, 0.2f, 0.0001f));
			CHECK(Equals(result.m_11, 0.8f, 0.0001f));
			CHECK(result == one);
		}
		...
		TEST_CASE("Subtraction")
		{
			...
			CHECK(Equals(result.m_00, 0.0f, 0.0001f));
			CHECK(Equals(result.m_01, 5.0f, 0.0001f));
			CHECK(Equals(result.m_10, 18.0f, 0.0001f));
			CHECK(Equals(result.m_11, 2.0f, 0.0001f));
			CHECK(result == one);
		}
	}
}
