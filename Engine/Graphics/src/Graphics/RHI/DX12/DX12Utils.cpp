...
DXGI_FORMAT PixelFormatToDXFormat[static_cast<int>(PixelFormat::MAX)] =
{
    ...
    DXGI_FORMAT_R32G8X24_TYPELESS, /// TODO Low: R32G8X24_Typeless
    DXGI_FORMAT_D32_FLOAT_S8X24_UINT,
    DXGI_FORMAT_R32_FLOAT_X8X24_TYPELESS,  /// TODO Low: R32_Float_X8X24_Typeless
    DXGI_FORMAT_X32_TYPELESS_G8X24_UINT, /// TODO Low: X32_Typeless_G8X24_UInt
...
#define COMPARE_AND_SET(value, bitToCompare, bitToSet, result) if (value & static_cast<u32>(bitToCompare)) { result = bitToSet; }
        ...
        D3D12_DSV_DIMENSION TextureTypeToDX12DSVDimension(TextureType type)
        {
            ...
            case TextureType::TexCube:      return D3D12_DSV_DIMENSION::D3D12_DSV_DIMENSION_TEXTURE2DARRAY;
            default:
                break;
            }
            FAIL_ASSERT();
