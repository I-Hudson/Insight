	...
	namespace Graphics
	{
		namespace RHI::DX12
		{
			...
			public:
				...
				DescriptorHeapHandle_DX12 GetUAVHandle() const;
				...
				DescriptorHeapHandle_DX12 GetSingleLayerUAVHandle(u32 const index) const;
			...
			private:
				DescriptorHeapHandle_DX12 CreateSharderResouceView(u32 mip_index, u32 mip_count, u32 layer_count, u32 layer_index, DescriptorHeapTypes heap, ImageUsageFlagsBits imageUsage);
			...
			private:
				...
				DescriptorHeapHandle_DX12 m_allLayerUAVHandle;							// Image view for all layers.
				std::vector<DescriptorHeapHandle_DX12> m_singleLayerUAVHandle;			// Image view for each layer.
