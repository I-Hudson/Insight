...
namespace Insight
{
	...
	namespace Graphics
	{
		...
		public:
			...
			virtual void SetSwaphchainResolution(Maths::IVector2 resolution) = 0;
			virtual Maths::IVector2 GetSwaphchainResolution() const = 0;
		...
		protected:
			...
			Maths::IVector2 m_swapchainBufferSize;
