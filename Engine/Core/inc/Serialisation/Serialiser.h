...
namespace Insight::Serialisation::Internal
{
    ...
    template<typename TypeSerialiser, typename TypeMigration = void, typename TObject>
    void SerialiseNamedPropertyRemoved(ISerialiser* serialiser, u32 version, u32 versionAdded, u32 versionRemoved, const char* propertyName, TObject* object, Options options)
    {
        if (options.Action == SerialiseAction::Deserialise)
        {
            if (VersionCheck(version, versionAdded, versionRemoved))
            {
                ...
                auto data = ::Insight::Serialisation::DeserialiseProperty<TypeSerialiser, PropertyType>(serialiser, propertyName);

                if constexpr (!std::is_void_v<TypeMigration>)
                {
                    MigrationDeserialiser<TypeMigration, TObject, TypeSerialiser> migrationDeserialiser = MigrationDeserialiser<TypeMigration, TObject, TypeSerialiser>();
                    migrationDeserialiser(object, &data);
                }
            }
        }
    }
...
#define SERIALISE_NAMED_PROPERTY_REMOVED(TYPE_SERIALISER, PROPERTY_NAME, VERSION_ADDED, VERSION_REMOVED, TYPE_MIGRATION)\
...
#define SERIALISE_PROPERTY_REMOVED(TYPE_SERIALISER, PROPERTY_NAME, VERSION_ADDED, VERSION_REMOVED)                              SERIALISE_NAMED_PROPERTY_REMOVED(TYPE_SERIALISER, PROPERTY_NAME, VERSION_ADDED, VERSION_REMOVED, void)
#define SERIALISE_PROPERTY_REMOVED_MIGRATE(TYPE_SERIALISER, PROPERTY_NAME, VERSION_ADDED, VERSION_REMOVED, TYPE_MIGRATION)      SERIALISE_NAMED_PROPERTY_REMOVED(TYPE_SERIALISER, PROPERTY_NAME, VERSION_ADDED, VERSION_REMOVED, TYPE_MIGRATION)
...
#define SERIALISE_COMPLEX_THIS_REMOVED(TYPE_SERIALISER, VERSION_ADDED, VERSION_REMOVED, TYPE_MIGRATION)                         SERIALISE_NAMED_COMPLEX_THIS_REMOVED(TYPE_SERIALISER, VERSION_ADDED, VERSION_REMOVED, TYPE_MIGRATION)
